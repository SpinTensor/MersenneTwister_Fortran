PROGRAM test_random_uniform_restart
   ...
   TYPE(rng_uniform_type) :: rng_state_cont
   TYPE(rng_uniform_type) :: rng_state_restr
   ...
   CALL init_rng(1337, 42.0_dp, 137.0_dp,rng_state_cont)
...
END PROGRAM test_random_uniform_restart
