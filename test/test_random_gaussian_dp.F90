PROGRAM test_random_gaussian_dp
   ...
   IF (passed) THEN
      ...
      passed = ABS(random + 62.690364060171319_dp) < eps
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random1d == 0.0_dp)) &
               .AND. &
               (ABS(random1d(3) + 73.769853417437233_dp) < eps)
      DEALLOCATE(random1d)
      NULLIFY(random1d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_1d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random2d == 0.0_dp)) &
               .AND. &
               (ABS(random2d(3,3) - 42.114343784567644_dp) < eps)
      DEALLOCATE(random2d)
      NULLIFY(random2d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_2d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random3d == 0.0_dp)) &
               .AND. &
               (ABS(random3d(3,3,3) - 110.23569707098409_dp) < eps)
      DEALLOCATE(random3d)
      NULLIFY(random3d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_3d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random4d == 0.0_dp)) &
               .AND. &
               (ABS(random4d(3,3,3,3) + 115.01261458965726_dp) < eps)
      DEALLOCATE(random4d)
      NULLIFY(random4d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_4d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random5d == 0.0_dp)) &
               .AND. &
               (ABS(random5d(3,3,3,3,3) + 14.477186963391745_dp) < eps)
      DEALLOCATE(random5d)
      NULLIFY(random5d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_5d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random6d == 0.0_dp)) &
               .AND. &
               (ABS(random6d(3,3,3,3,3,3) + 127.06886543386764_dp) < eps)
      DEALLOCATE(random6d)
      NULLIFY(random6d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_6d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random7d == 0.0_dp)) &
               .AND. &
               (ABS(random7d(3,3,3,3,3,3,3) - 69.060488305154735_dp) < eps)
      DEALLOCATE(random7d)
      NULLIFY(random7d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_7d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random8d == 0.0_dp)) &
               .AND. &
               (ABS(random8d(3,3,3,3,3,3,3,3) - 212.67259877233440_dp) < eps)
      DEALLOCATE(random8d)
      NULLIFY(random8d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_8d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random9d == 0.0_dp)) &
               .AND. &
               (ABS(random9d(3,3,3,3,3,3,3,3,3) + 138.76324755466862_dp) < eps)
      DEALLOCATE(random9d)
      NULLIFY(random9d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_9d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random10d == 0.0_dp)) &
               .AND. &
               (ABS(random10d(3,3,3,3,3,3,3,3,3,3) + 206.05406587007803_dp) < eps)
      DEALLOCATE(random10d)
      NULLIFY(random10d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_10d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random11d == 0.0_dp)) &
               .AND. &
               (ABS(random11d(3,3,3,3,3,3,3,3,3,3,3) + 87.708594785160074_dp) < eps)
      DEALLOCATE(random11d)
      NULLIFY(random11d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_11d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random12d == 0.0_dp)) &
               .AND. &
               (ABS(random12d(3,3,3,3,3,3,3,3,3,3,3,3) + 113.78498094210832_dp) < eps)
      DEALLOCATE(random12d)
      NULLIFY(random12d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_12d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random13d == 0.0_dp)) &
               .AND. &
               (ABS(random13d(3,3,3,3,3,3,3,3,3,3,3,3,3) + 21.958600896699174_dp) < eps)
      DEALLOCATE(random13d)
      NULLIFY(random13d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_13d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random14d == 0.0_dp)) &
               .AND. &
               (ABS(random14d(3,3,3,3,3,3,3,3,3,3,3,3,3,3) - 22.900312600521126_dp) < eps)
      DEALLOCATE(random14d)
      NULLIFY(random14d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_14d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random15d == 0.0_dp)) &
               .AND. &
               (ABS(random15d(3,3,3,3,3,3,3,3,3,3,3,3,3,3,3) - 127.09776107582077_dp) < eps)
      DEALLOCATE(random15d)
      NULLIFY(random15d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_gaussian_dp_15d of module random"
      END IF
   END IF
#endif
#endif
...
END PROGRAM test_random_gaussian_dp
