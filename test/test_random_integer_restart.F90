PROGRAM test_random_integer_restart
   ...
   TYPE(rng_integer_type) :: rng_state_cont
   TYPE(rng_integer_type) :: rng_state_restr

   CHARACTER(LEN=default_rng_state_length) :: state_string

   INTEGER(KIND=isp) :: random1, random2
   INTEGER :: i
   ...
   CALL init_rng(1337, rng_state_cont)
...
END PROGRAM test_random_integer_restart
