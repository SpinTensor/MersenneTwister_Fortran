PROGRAM test_random_uniform_sp
   ...
   IF (passed) THEN
      ...
      passed = ABS(random - 108.502457_sp) < eps
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random1d == 0.0_sp)) &
               .AND. &
               (ABS(random1d(3) - 109.710541_sp) < eps)
      DEALLOCATE(random1d)
      NULLIFY(random1d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_1d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random2d == 0.0_sp)) &
               .AND. &
               (ABS(random2d(3,3) - 123.929184_sp) < eps)
      DEALLOCATE(random2d)
      NULLIFY(random2d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_2d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random3d == 0.0_sp)) &
               .AND. &
               (ABS(random3d(3,3,3) - 69.7213593_sp) < eps)
      DEALLOCATE(random3d)
      NULLIFY(random3d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_3d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random4d == 0.0_sp)) &
               .AND. &
               (ABS(random4d(3,3,3,3) - 89.1841583_sp) < eps)
      DEALLOCATE(random4d)
      NULLIFY(random4d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_4d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random5d == 0.0_sp)) &
               .AND. &
               (ABS(random5d(3,3,3,3,3) - 129.695892_sp) < eps)
      DEALLOCATE(random5d)
      NULLIFY(random5d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_5d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random6d == 0.0_sp)) &
               .AND. &
               (ABS(random6d(3,3,3,3,3,3) - 82.8779678_sp) < eps)
      DEALLOCATE(random6d)
      NULLIFY(random6d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_6d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random7d == 0.0_sp)) &
               .AND. &
               (ABS(random7d(3,3,3,3,3,3,3) - 43.1831894_sp) < eps)
      DEALLOCATE(random7d)
      NULLIFY(random7d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_7d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random8d == 0.0_sp)) &
               .AND. &
               (ABS(random8d(3,3,3,3,3,3,3,3) - 85.7011566_sp) < eps)
      DEALLOCATE(random8d)
      NULLIFY(random8d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_8d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random9d == 0.0_sp)) &
               .AND. &
               (ABS(random9d(3,3,3,3,3,3,3,3,3) - 126.325485_sp) < eps)
      DEALLOCATE(random9d)
      NULLIFY(random9d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_9d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random10d == 0.0_sp)) &
               .AND. &
               (ABS(random10d(3,3,3,3,3,3,3,3,3,3) - 59.4195633_sp) < eps)
      DEALLOCATE(random10d)
      NULLIFY(random10d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_10d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random11d == 0.0_sp)) &
               .AND. &
               (ABS(random11d(3,3,3,3,3,3,3,3,3,3,3) - 125.237907_sp) < eps)
      DEALLOCATE(random11d)
      NULLIFY(random11d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_11d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random12d == 0.0_sp)) &
               .AND. &
               (ABS(random12d(3,3,3,3,3,3,3,3,3,3,3,3) - 86.4732666_sp) < eps)
      DEALLOCATE(random12d)
      NULLIFY(random12d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_12d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random13d == 0.0_sp)) &
               .AND. &
               (ABS(random13d(3,3,3,3,3,3,3,3,3,3,3,3,3) - 132.551102_sp) < eps)
      DEALLOCATE(random13d)
      NULLIFY(random13d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_13d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random14d == 0.0_sp)) &
               .AND. &
               (ABS(random14d(3,3,3,3,3,3,3,3,3,3,3,3,3,3) - 115.998756_sp) < eps)
      DEALLOCATE(random14d)
      NULLIFY(random14d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_14d of module random"
      END IF
   END IF
   ...
   IF (passed) THEN
      ...
      passed = (.NOT.ANY(random15d == 0.0_sp)) &
               .AND. &
               (ABS(random15d(3,3,3,3,3,3,3,3,3,3,3,3,3,3,3) - 48.2788162_sp) < eps)
      DEALLOCATE(random15d)
      NULLIFY(random15d)
      IF (.NOT.passed) THEN
         WRITE(UNIT=OUTPUT_UNIT, FMT=*) "Fail in routine next_random_uniform_sp_15d of module random"
      END IF
   END IF
#endif
#endif
...
END PROGRAM test_random_uniform_sp
